...
public class GuildTreeLevelRequirement extends Requirement {
    @Override
    public String getSymbol() {
        return "guild_treelevel";
    }
    ...
    public boolean canPass(Player p, String str) {
        ...
        if (guild.getTreelevel() >= Double.parseDouble(args[1])){
            return true;
        }
        p.sendMessage(lang.plugin+lang.noenough_treelevel.replace("%value%",args[1]));
        return false;
    }
